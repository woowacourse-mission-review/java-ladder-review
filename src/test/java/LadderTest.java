...
public class LadderTest {
    ...
    void create_Ladder() {
        assertDoesNotThrow(() -> new Ladder(5, 3, new HasLineCreateStrategy()));
    }
    ...
    void run_Ladder_with_HasLineCreateStrategy() {
        Ladder ladder = new Ladder(5, 3, new HasLineCreateStrategy());
    ...
    void run_Ladder_with_EmptyLineCreateStrategy() {
        Ladder ladder = new Ladder(5, 3, new EmptyLineCreateStrategy());
